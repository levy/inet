...
#ifndef __INET_CONNECTIONVISUALIZERBASE_H
#define __INET_CONNECTIONVISUALIZERBASE_H
...
class INET_API ConnectionVisualizerBase : public VisualizerBase, public cListener
{
  protected:
  ...
  protected:
    ...
    virtual const Connection *createConnection(cModule *source, cModule *destination) const = 0;
...
#endif // ifndef __INET_CONNECTIONVISUALIZERBASE_H
